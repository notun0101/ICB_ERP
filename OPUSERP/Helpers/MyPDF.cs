...
public class MyPDF
	{
		...
		public string GeneratePDF(out string fileName, string url, string headerUrl, string footerUrl)
		{
			string status = "done";
			fileName = "Document_" + DateTime.Now.ToString("yyyy-MM-dd_HH-ss") + ".pdf";
			...
			var doc = new HtmlToPdfDocument()
			{
				GlobalSettings =
				{
					...
					Orientation = Orientation.Portrait,
					PaperSize = PaperKind.A4,
					Margins = new MarginSettings() { Top = 10, Bottom = 20, Left = 10, Right = 10 },
					Out = rootPath+fileName
				},
				Objects =
				{
					new ObjectSettings()
					{
						PagesCount = true,
						HeaderSettings = { FontName = "Arial", FontSize = 3, Right = "", Line = false, HtmUrl=""},
						FooterSettings = { HtmUrl = footerUrl, Spacing = 0, FontName = "Arial", FontSize = 6, Line = false, Center = " ", Left = "Print At: " + DateTime.Now.ToString(), Right = "Page [page] of [toPage]" },
						Page =url,
					}
				}
			};
		...
		public string GeneratePDFWithOutPrintInfo(out string fileName, string url)
        {
            string status = "done";
            fileName = "Document_" + DateTime.Now.ToString("yyyy-MM-dd_HH-ss") + ".pdf";
            ...
            var doc = new HtmlToPdfDocument()
            {
                ...
                Objects =
                {
                    new ObjectSettings()
                    {
                        PagesCount = true,
                        HeaderSettings = { FontName = "Arial", FontSize = 3, Right = "", Line = false, HtmUrl=""},
                        FooterSettings = { FontName = "Arial", FontSize = 6, Line = false, Center = " ", Left = "", Right = "Page [page] of [toPage]" },
                        Page =url,
                    }
                }
            };
        ...
        public string GeneratePDFForMail(out string fileName, string prefix, string url)
		{
			string status = "done";
			fileName = prefix + "_" + DateTime.Now.ToString("yyyy-MM-dd_HH-ss") + ".pdf";
