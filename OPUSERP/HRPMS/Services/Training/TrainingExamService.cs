...
{
    public class TrainingExamService : ITrainingExamService
    {
        private readonly ERPDbContext _context;

        public TrainingExamService(ERPDbContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.trainingExams.Include(x => x.trainer).Include(x => x.trainingInfo).AsNoTracking().ToListAsync();
        }
