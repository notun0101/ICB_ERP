...
namespace OPUSERP.Areas.MemberInfo.Models.Lang
{
    public class InfoViewLn
    {
        ...
        public string PRLStartDate { get; set; }
        public string PRLEndDate { get; set; }
        public string emailAddressPersonal { get; set; }
        public string presentAddressInfo { get; set; }
        public string permanentAddressInfo { get; set; }
        ...
        public string naturalPunishment { get; set; }
        public string punishmentDate { get; set; }
        public string goWithDate { get; set; }
        ...
        public string promotedPayScale { get; set; }
        ...
        public string memOrganization { get; set; }
