...
namespace OPUSERP.Areas.CRMLead.Controllers
{
    ...
    public class ActivityController : Controller
    {
        ...
        public async Task<IActionResult> ActivityMasterViewForActivities(int id)
        {
            string username = HttpContext.User.Identity.Name;
            ViewBag.Id = id;
            var activitymaster = await activityMasterService.GetActivityMasterById(id);
        ...
        public async Task<IActionResult> GetChildActivityMaster(int id)
        {
            var data = await activityMasterService.GetChildActivityMasterById(id);
            return Json(data);
        }
        ...
        public async Task<IActionResult> ActivityMasterViewAll(int id)
        {
            ...
            ActivityMasterViewModel model = new ActivityMasterViewModel()
            {
                leads =await leadsService.GetLeadDetailsById(id),
            ...
            ViewBag.leadId = model.leads.Id;
            ViewBag.leadName = model.leads.leadName;

            return View(model);
        }

        public async Task<IActionResult> ActivityMasterViewAllTree(int id)
        {
            var activityMaster =await activityMasterService.GetActivityMasterByLeadIdParent(id);
            var data = "";
            foreach (var item in activityMaster)
            {
                data += await activityMasterService.GetActivityMasterByleadIdJson(item.Id,0);
            }
        ...
        {
            var leads = await leadsService.GetLeadsById(id);
            ActivityMasterViewModel model = new ActivityMasterViewModel()
            {
                activityMasterCViewModels = await activityMasterService.GetActivityMasterCByLeadId(id)
            };
            ...
            ViewBag.leadId = id;
            ViewBag.inClient = leads?.isClient;
            return View(model);
        }

        public async Task<IActionResult> ActivityForCalender(int id)
        {
            ActivityMasterViewModel model = new ActivityMasterViewModel()
            {
                activityMasterCViewModels = await activityMasterService.GetActivityMasterCByLeadId(id)
        ...
        public async Task<IActionResult> AllActivityForCalender()
        {
            ActivityMasterViewModel model = new ActivityMasterViewModel()
            {
                activityMasters = await activityMasterService.GetAllActivityMaster()
            };
            return Json(model);
        }

        public async Task<IActionResult> ActivityMasterAdd(int id, string leadName, int? masterId)
        {
            string username = HttpContext.User.Identity.Name;
            var userinfo = await userInfo.GetUserInfoByUser(username);
            var team = new Team();
        ...
        public async Task<IActionResult> ActivityMasterPersonal(int id, string leadName, int? masterId)
        {
            string username = HttpContext.User.Identity.Name;
            var userinfo = await userInfo.GetUserInfoByUser(username);
            var team = new Team();
        ...
        public async Task<IActionResult> ActivityMasterPer(int id, string leadName, int? masterId)
        {
            var leads = await leadsService.GetLeadsById(id);
            ActivityMasterViewModel model = new ActivityMasterViewModel()
            {
