...
namespace OPUSERP.Areas.Auth.Controllers
{
    ...
    public class UserRoleAssignController : Controller
    {
        ...
        public UserRoleAssignController(RoleManager<ApplicationRole> roleManager, UserManager<ApplicationUser> userManager, IUserInfoes userInfoes, IERPModuleService eRPModuleService)
        {
