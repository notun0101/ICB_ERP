...
namespace OPUSERP.Areas.Payroll.Models
{
    public class FinalSettlementViewModel
    {
        ...
        public int?[] headIdDeductAll { get; set; }
        public decimal?[] amountDeductAll { get; set; }

        public IEnumerable<FinalSettlement> finalSettlements { get; set; }
        public IEnumerable<ResignInformation>  resigns { get; set; }
        public FinalSettlement finalSettlementData { get; set; }
        public FinalSettlementDataViewModel finalSettlementDataViewModel { get; set; }
