...
namespace OPUSERP.Areas.POS.Models
{
    ...
    {
        private const int _itemSepHeight = 2;
        SizeF _titleSize = SizeF.Empty;
        SizeF _barCodeSize = SizeF.Empty;
        SizeF _codeStringSize = SizeF.Empty;
        public BarCode39()
        {
            _titleFont = new Font("Arial", 9);
            _codeStringFont = new Font("Arial", 9);
        }
        ...
        private Bitmap CreateImageContainer(string barCode, ref int bcodeWidth, ref int bcodeHeight)
        {
            ...
            Bitmap tmpBitmap = new Bitmap(2, 2, PixelFormat.Format32bppArgb);
