...
namespace OPUSERP.Areas.REMS.Controllers
{
    ...
    public class ReturnFromTechnicalTeamController : Controller
    {
        ...
        public ReturnFromTechnicalTeamController(IClaimRegisterService claimRegisterService, IUserInfoes userInfoes, IClaimAssignService claimAssignService, IRepairTransactionLogService repairTransactionLogService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ClaimRegisterViewModel model = new ClaimRegisterViewModel
            {
                ...
                //claimAssignViewModels = await claimAssignService.GetClaimAssignListByAssignType(userInfo.UserId, 1)
            };
            return View(model);
        }
        ...
        public async Task<IActionResult> Index([FromForm] ClaimRegisterViewModel model)
        {
            ...
            ClaimAssign data = new ClaimAssign
            {
                ...
                remarks = "Assign To Employee for Repaire Head"
            };
